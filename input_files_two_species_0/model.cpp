...
void Models::model_0(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	const double KB_2 = part_params[3];
	const double K_1 = part_params[4];
	const double K_2 = part_params[5];
	const double K_omega_1 = part_params[6];
	const double K_omega_2 = part_params[7];
	...
	const double kBmax_2 = part_params[14];
	const double mu_max_1 = part_params[15];
	const double mu_max_2 = part_params[16];
	const double nB_1 = part_params[17];
	const double nB_2 = part_params[18];
	const double n_omega_1 = part_params[19];
	const double n_omega_2 = part_params[20];
	const double omega_max_1 = part_params[21];
	const double omega_max_2 = part_params[22];

	//Species order is: N_1 N_2 S_glu B_1 B_2 A_1 A_2 
	dydt[0] = -std::pow(y[3], n_omega_1)*y[0]*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - std::pow(y[4], n_omega_2)*y[0]*omega_max_2/(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)) - D*y[0] + y[0]*y[2]*mu_max_1/(K_1 + y[2]);
	dydt[1] = -std::pow(y[3], n_omega_1)*y[1]*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - std::pow(y[4], n_omega_2)*y[1]*omega_max_2/(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)) - D*y[1] + y[1]*y[2]*mu_max_2/(K_2 + y[2]);
	dydt[2] = -C*y[0]*y[2]*mu_max_1/(g_1*(K_1 + y[2])) - C*y[1]*y[2]*mu_max_2/(g_2*(K_2 + y[2])) + D*(S0_glu - y[2]);
	dydt[3] = std::pow(y[5], nB_1)*C*y[0]*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)) - y[3]*D;
	dydt[4] = std::pow(y[6], nB_2)*C*y[1]*kBmax_2/(std::pow(y[6], nB_2) + std::pow(KB_2, nB_2)) - y[4]*D;
	dydt[5] = -y[5]*D + C*y[0]*kA_1 + C*y[1]*kA_1;
	dydt[6] = -y[6]*D + C*y[0]*kA_2 + C*y[1]*kA_2;
...
void Models::jac_0(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 0 , 0 ) = -std::pow(y[3], n_omega_1)*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - std::pow(y[4], n_omega_2)*omega_max_2/(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)) - D + y[2]*mu_max_1/(K_1 + y[2]);
	J( 0 , 1 ) = 0;
	J( 0 , 2 ) = -y[0]*y[2]*mu_max_1/std::pow(K_1 + y[2], 2) + y[0]*mu_max_1/(K_1 + y[2]);
	...
	J( 0 , 4 ) = std::pow(y[4], 2*n_omega_2)*y[0]*n_omega_2*omega_max_2/(y[4]*std::pow(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2), 2)) - std::pow(y[4], n_omega_2)*y[0]*n_omega_2*omega_max_2/(y[4]*(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)));
	J( 0 , 5 ) = 0;
	J( 0 , 6 ) = 0;
	J( 1 , 0 ) = 0;
	J( 1 , 1 ) = -std::pow(y[3], n_omega_1)*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - std::pow(y[4], n_omega_2)*omega_max_2/(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)) - D + y[2]*mu_max_2/(K_2 + y[2]);
	J( 1 , 2 ) = -y[1]*y[2]*mu_max_2/std::pow(K_2 + y[2], 2) + y[1]*mu_max_2/(K_2 + y[2]);
	...
	J( 1 , 4 ) = std::pow(y[4], 2*n_omega_2)*y[1]*n_omega_2*omega_max_2/(y[4]*std::pow(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2), 2)) - std::pow(y[4], n_omega_2)*y[1]*n_omega_2*omega_max_2/(y[4]*(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)));
	J( 1 , 5 ) = 0;
	J( 1 , 6 ) = 0;
	J( 2 , 0 ) = -C*y[2]*mu_max_1/(g_1*(K_1 + y[2]));
	J( 2 , 1 ) = -C*y[2]*mu_max_2/(g_2*(K_2 + y[2]));
	J( 2 , 2 ) = C*y[0]*y[2]*mu_max_1/(g_1*std::pow(K_1 + y[2], 2)) - C*y[0]*mu_max_1/(g_1*(K_1 + y[2])) + C*y[1]*y[2]*mu_max_2/(g_2*std::pow(K_2 + y[2], 2)) - C*y[1]*mu_max_2/(g_2*(K_2 + y[2])) - D;
	J( 2 , 3 ) = 0;
	J( 2 , 4 ) = 0;
	J( 2 , 5 ) = 0;
	J( 2 , 6 ) = 0;
	...
	J( 3 , 6 ) = 0;
	J( 4 , 0 ) = 0;
	J( 4 , 1 ) = std::pow(y[6], nB_2)*C*kBmax_2/(std::pow(y[6], nB_2) + std::pow(KB_2, nB_2));
	J( 4 , 2 ) = 0;
	J( 4 , 3 ) = 0;
	J( 4 , 4 ) = -D;
	J( 4 , 5 ) = 0;
	J( 4 , 6 ) = -std::pow(y[6], 2*nB_2)*C*y[1]*kBmax_2*nB_2/(y[6]*std::pow(std::pow(y[6], nB_2) + std::pow(KB_2, nB_2), 2)) + std::pow(y[6], nB_2)*C*y[1]*kBmax_2*nB_2/(y[6]*(std::pow(y[6], nB_2) + std::pow(KB_2, nB_2)));
	J( 5 , 0 ) = C*kA_1;
	J( 5 , 1 ) = C*kA_1;
	J( 5 , 2 ) = 0;
	J( 5 , 3 ) = 0;
...
void Models::model_1(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	//Species order is: N_1 N_2 S_glu B_1 B_2 A_1 A_2 
	dydt[0] = -std::pow(y[3], n_omega_1)*y[0]*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - std::pow(y[4], n_omega_2)*y[0]*omega_max_2/(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)) - D*y[0] + y[0]*y[2]*mu_max_1/(K_1 + y[2]);
	dydt[1] = -std::pow(y[3], n_omega_1)*y[1]*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - D*y[1] + y[1]*y[2]*mu_max_2/(K_2 + y[2]);
	dydt[2] = -C*y[0]*y[2]*mu_max_1/(g_1*(K_1 + y[2])) - C*y[1]*y[2]*mu_max_2/(g_2*(K_2 + y[2])) + D*(S0_glu - y[2]);
	dydt[3] = std::pow(y[5], nB_1)*C*y[0]*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)) - y[3]*D;
	dydt[4] = std::pow(y[6], nB_2)*C*y[1]*kBmax_2/(std::pow(y[6], nB_2) + std::pow(KB_2, nB_2)) - y[4]*D;
	dydt[5] = -y[5]*D + C*y[0]*kA_1 + C*y[1]*kA_1;
...
void Models::jac_1(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 0 , 6 ) = 0;
	J( 1 , 0 ) = 0;
	J( 1 , 1 ) = -std::pow(y[3], n_omega_1)*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - D + y[2]*mu_max_2/(K_2 + y[2]);
	J( 1 , 2 ) = -y[1]*y[2]*mu_max_2/std::pow(K_2 + y[2], 2) + y[1]*mu_max_2/(K_2 + y[2]);
	J( 1 , 3 ) = std::pow(y[3], 2*n_omega_1)*y[1]*n_omega_1*omega_max_1/(y[3]*std::pow(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1), 2)) - std::pow(y[3], n_omega_1)*y[1]*n_omega_1*omega_max_1/(y[3]*(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)));
	J( 1 , 4 ) = 0;
	J( 1 , 5 ) = 0;
...
void Models::model_2(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	//Species order is: N_1 N_2 S_glu B_1 B_2 A_1 A_2 
	dydt[0] = -std::pow(y[3], n_omega_1)*y[0]*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - std::pow(y[4], n_omega_2)*y[0]*omega_max_2/(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)) - D*y[0] + y[0]*y[2]*mu_max_1/(K_1 + y[2]);
	dydt[1] = -std::pow(y[4], n_omega_2)*y[1]*omega_max_2/(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)) - D*y[1] + y[1]*y[2]*mu_max_2/(K_2 + y[2]);
	dydt[2] = -C*y[0]*y[2]*mu_max_1/(g_1*(K_1 + y[2])) - C*y[1]*y[2]*mu_max_2/(g_2*(K_2 + y[2])) + D*(S0_glu - y[2]);
	dydt[3] = std::pow(y[5], nB_1)*C*y[0]*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)) - y[3]*D;
	dydt[4] = std::pow(y[6], nB_2)*C*y[1]*kBmax_2/(std::pow(y[6], nB_2) + std::pow(KB_2, nB_2)) - y[4]*D;
	dydt[5] = -y[5]*D + C*y[0]*kA_1 + C*y[1]*kA_1;
...
void Models::jac_2(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 0 , 6 ) = 0;
	J( 1 , 0 ) = 0;
	J( 1 , 1 ) = -std::pow(y[4], n_omega_2)*omega_max_2/(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)) - D + y[2]*mu_max_2/(K_2 + y[2]);
	J( 1 , 2 ) = -y[1]*y[2]*mu_max_2/std::pow(K_2 + y[2], 2) + y[1]*mu_max_2/(K_2 + y[2]);
	J( 1 , 3 ) = 0;
	J( 1 , 4 ) = std::pow(y[4], 2*n_omega_2)*y[1]*n_omega_2*omega_max_2/(y[4]*std::pow(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2), 2)) - std::pow(y[4], n_omega_2)*y[1]*n_omega_2*omega_max_2/(y[4]*(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)));
	J( 1 , 5 ) = 0;
...
void Models::model_3(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	//Species order is: N_1 N_2 S_glu B_1 B_2 A_1 A_2 
	dydt[0] = -std::pow(y[3], n_omega_1)*y[0]*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - std::pow(y[4], n_omega_2)*y[0]*omega_max_2/(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)) - D*y[0] + y[0]*y[2]*mu_max_1/(K_1 + y[2]);
	dydt[1] = -D*y[1] + y[1]*y[2]*mu_max_2/(K_2 + y[2]);
	dydt[2] = -C*y[0]*y[2]*mu_max_1/(g_1*(K_1 + y[2])) - C*y[1]*y[2]*mu_max_2/(g_2*(K_2 + y[2])) + D*(S0_glu - y[2]);
	dydt[3] = std::pow(y[5], nB_1)*C*y[0]*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)) - y[3]*D;
	dydt[4] = std::pow(y[6], nB_2)*C*y[1]*kBmax_2/(std::pow(y[6], nB_2) + std::pow(KB_2, nB_2)) - y[4]*D;
	dydt[5] = -y[5]*D + C*y[0]*kA_1 + C*y[1]*kA_1;
...
void Models::model_16(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	const double D = part_params[1];
	const double KB_1 = part_params[2];
	const double K_1 = part_params[3];
	const double K_2 = part_params[4];
	...
	//Species order is: N_1 N_2 S_glu B_1 A_1 A_2 
	dydt[0] = -std::pow(y[3], n_omega_1)*y[0]*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - D*y[0] + y[0]*y[2]*mu_max_1/(K_1 + y[2]);
	dydt[1] = -std::pow(y[3], n_omega_1)*y[1]*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - D*y[1] + y[1]*y[2]*mu_max_2/(K_2 + y[2]);
	dydt[2] = -C*y[0]*y[2]*mu_max_1/(g_1*(K_1 + y[2])) - C*y[1]*y[2]*mu_max_2/(g_2*(K_2 + y[2])) + D*(S0_glu - y[2]);
	dydt[3] = std::pow(y[4], nB_1)*C*y[0]*kBmax_1/(std::pow(y[4], nB_1) + std::pow(KB_1, nB_1)) + std::pow(y[5], nB_1)*C*y[1]*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)) - y[3]*D;
	dydt[4] = -y[4]*D + C*y[0]*kA_1;
	dydt[5] = -y[5]*D + C*y[0]*kA_2 + C*y[1]*kA_2;
...
void Models::jac_16(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 0 , 0 ) = -std::pow(y[3], n_omega_1)*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - D + y[2]*mu_max_1/(K_1 + y[2]);
	J( 0 , 1 ) = 0;
	J( 0 , 2 ) = -y[0]*y[2]*mu_max_1/std::pow(K_1 + y[2], 2) + y[0]*mu_max_1/(K_1 + y[2]);
	J( 0 , 3 ) = std::pow(y[3], 2*n_omega_1)*y[0]*n_omega_1*omega_max_1/(y[3]*std::pow(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1), 2)) - std::pow(y[3], n_omega_1)*y[0]*n_omega_1*omega_max_1/(y[3]*(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)));
	J( 0 , 4 ) = 0;
	...
	J( 3 , 1 ) = std::pow(y[5], nB_1)*C*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1));
	J( 3 , 2 ) = 0;
	J( 3 , 3 ) = -D;
	...
	J( 3 , 5 ) = -std::pow(y[5], 2*nB_1)*C*y[1]*kBmax_1*nB_1/(y[5]*std::pow(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1), 2)) + std::pow(y[5], nB_1)*C*y[1]*kBmax_1*nB_1/(y[5]*(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)));
	J( 4 , 0 ) = C*kA_1;
	J( 4 , 1 ) = 0;
	J( 4 , 2 ) = 0;
	J( 4 , 3 ) = 0;
...
void Models::model_26(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	//Species order is: N_1 N_2 S_glu B_1 B_2 A_1 A_2 
	dydt[0] = -std::pow(y[4], n_omega_2)*y[0]*omega_max_2/(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)) - D*y[0] + y[0]*y[2]*mu_max_1/(K_1 + y[2]);
	dydt[1] = -std::pow(y[3], n_omega_1)*y[1]*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - std::pow(y[4], n_omega_2)*y[1]*omega_max_2/(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)) - D*y[1] + y[1]*y[2]*mu_max_2/(K_2 + y[2]);
	dydt[2] = -C*y[0]*y[2]*mu_max_1/(g_1*(K_1 + y[2])) - C*y[1]*y[2]*mu_max_2/(g_2*(K_2 + y[2])) + D*(S0_glu - y[2]);
	dydt[3] = std::pow(y[5], nB_1)*C*y[0]*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)) - y[3]*D;
	dydt[4] = std::pow(y[6], nB_2)*C*y[1]*kBmax_2/(std::pow(y[6], nB_2) + std::pow(KB_2, nB_2)) - y[4]*D;
...
void Models::jac_26(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 0 , 0 ) = -std::pow(y[4], n_omega_2)*omega_max_2/(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)) - D + y[2]*mu_max_1/(K_1 + y[2]);
	J( 0 , 1 ) = 0;
	J( 0 , 2 ) = -y[0]*y[2]*mu_max_1/std::pow(K_1 + y[2], 2) + y[0]*mu_max_1/(K_1 + y[2]);
	J( 0 , 3 ) = 0;
	J( 0 , 4 ) = std::pow(y[4], 2*n_omega_2)*y[0]*n_omega_2*omega_max_2/(y[4]*std::pow(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2), 2)) - std::pow(y[4], n_omega_2)*y[0]*n_omega_2*omega_max_2/(y[4]*(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)));
...
void Models::model_34(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	//Species order is: N_1 N_2 S_glu B_1 A_1 A_2 
	dydt[0] = -D*y[0] + y[0]*y[2]*mu_max_1/(K_1 + y[2]);
	dydt[1] = -std::pow(y[3], n_omega_1)*y[1]*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - D*y[1] + y[1]*y[2]*mu_max_2/(K_2 + y[2]);
	dydt[2] = -C*y[0]*y[2]*mu_max_1/(g_1*(K_1 + y[2])) - C*y[1]*y[2]*mu_max_2/(g_2*(K_2 + y[2])) + D*(S0_glu - y[2]);
	dydt[3] = std::pow(y[4], nB_1)*C*y[0]*kBmax_1/(std::pow(y[4], nB_1) + std::pow(KB_1, nB_1)) + std::pow(y[5], nB_1)*C*y[1]*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)) - y[3]*D;
	dydt[4] = -y[4]*D + C*y[0]*kA_1;
...
void Models::model_39(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	//Species order is: N_1 N_2 S_glu B_1 B_2 A_1 
	dydt[0] = -std::pow(y[3], n_omega_1)*y[0]*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - std::pow(y[4], n_omega_2)*y[0]*omega_max_2/(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)) - D*y[0] + y[0]*y[2]*mu_max_1/(K_1 + y[2]);
	dydt[1] = -std::pow(y[3], n_omega_1)*y[1]*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - std::pow(y[4], n_omega_2)*y[1]*omega_max_2/(std::pow(y[4], n_omega_2) + std::pow(K_omega_2, n_omega_2)) - D*y[1] + y[1]*y[2]*mu_max_2/(K_2 + y[2]);
	dydt[2] = -C*y[0]*y[2]*mu_max_1/(g_1*(K_1 + y[2])) - C*y[1]*y[2]*mu_max_2/(g_2*(K_2 + y[2])) + D*(S0_glu - y[2]);
	dydt[3] = std::pow(y[5], nB_1)*C*y[0]*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)) - y[3]*D;
	dydt[4] = std::pow(y[5], nB_2)*C*y[1]*kBmax_2/(std::pow(y[5], nB_2) + std::pow(KB_2, nB_2)) - y[4]*D;
	dydt[5] = -y[5]*D + C*y[0]*kA_1 + C*y[1]*kA_1;
...
void Models::jac_39(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 3 , 5 ) = -std::pow(y[5], 2*nB_1)*C*y[0]*kBmax_1*nB_1/(y[5]*std::pow(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1), 2)) + std::pow(y[5], nB_1)*C*y[0]*kBmax_1*nB_1/(y[5]*(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)));
	J( 4 , 0 ) = 0;
	J( 4 , 1 ) = std::pow(y[5], nB_2)*C*kBmax_2/(std::pow(y[5], nB_2) + std::pow(KB_2, nB_2));
	J( 4 , 2 ) = 0;
	J( 4 , 3 ) = 0;
	J( 4 , 4 ) = -D;
	J( 4 , 5 ) = -std::pow(y[5], 2*nB_2)*C*y[1]*kBmax_2*nB_2/(y[5]*std::pow(std::pow(y[5], nB_2) + std::pow(KB_2, nB_2), 2)) + std::pow(y[5], nB_2)*C*y[1]*kBmax_2*nB_2/(y[5]*(std::pow(y[5], nB_2) + std::pow(KB_2, nB_2)));
	J( 5 , 0 ) = C*kA_1;
	J( 5 , 1 ) = C*kA_1;
	J( 5 , 2 ) = 0;
	J( 5 , 3 ) = 0;
...
void Models::model_55(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	dydt[1] = -D*y[1] + y[1]*y[2]*mu_max_2/(K_2 + y[2]);
	dydt[2] = -C*y[0]*y[2]*mu_max_1/(g_1*(K_1 + y[2])) - C*y[1]*y[2]*mu_max_2/(g_2*(K_2 + y[2])) + D*(S0_glu - y[2]);
	dydt[3] = std::pow(y[4], nB_1)*C*y[0]*kBmax_1/(std::pow(y[4], nB_1) + std::pow(KB_1, nB_1)) + std::pow(y[4], nB_1)*C*y[1]*kBmax_1/(std::pow(y[4], nB_1) + std::pow(KB_1, nB_1)) - y[3]*D;
	dydt[4] = -y[4]*D + C*y[0]*kA_1 + C*y[1]*kA_1;
...
void Models::jac_55(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 2 , 4 ) = 0;
	J( 3 , 0 ) = std::pow(y[4], nB_1)*C*kBmax_1/(std::pow(y[4], nB_1) + std::pow(KB_1, nB_1));
	J( 3 , 1 ) = std::pow(y[4], nB_1)*C*kBmax_1/(std::pow(y[4], nB_1) + std::pow(KB_1, nB_1));
	J( 3 , 2 ) = 0;
	J( 3 , 3 ) = -D;
	J( 3 , 4 ) = -std::pow(y[4], 2*nB_1)*C*y[0]*kBmax_1*nB_1/(y[4]*std::pow(std::pow(y[4], nB_1) + std::pow(KB_1, nB_1), 2)) - std::pow(y[4], 2*nB_1)*C*y[1]*kBmax_1*nB_1/(y[4]*std::pow(std::pow(y[4], nB_1) + std::pow(KB_1, nB_1), 2)) + std::pow(y[4], nB_1)*C*y[0]*kBmax_1*nB_1/(y[4]*(std::pow(y[4], nB_1) + std::pow(KB_1, nB_1))) + std::pow(y[4], nB_1)*C*y[1]*kBmax_1*nB_1/(y[4]*(std::pow(y[4], nB_1) + std::pow(KB_1, nB_1)));
	J( 4 , 0 ) = C*kA_1;
	J( 4 , 1 ) = C*kA_1;
	J( 4 , 2 ) = 0;
	J( 4 , 3 ) = 0;
