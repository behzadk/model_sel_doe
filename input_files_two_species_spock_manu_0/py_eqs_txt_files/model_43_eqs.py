	...
	dN_2 = ( - D * N_2 ) + N_2  * ( mu_max_2 * S_glu / ( K_mu_glu + S_glu ) ) * ( mu_max_2 * S_trp / ( K_mu_trp + S_trp ) ) - ( ( omega_max_1 * B_1**n_omega_1 / ( K_omega_1**n_omega_1 + B_1**n_omega_1 ) ) )  * N_2 

	dS_trp = ( D * ( S0_trp - S_trp ) ) - ( mu_max_2 * S_trp / ( K_mu_trp + S_trp ) ) * N_2 * C / g_2 
