...
python3 run_boost_rpr.py --config ./exp_configs/chaos_three_species.yaml --suffix $SGE_TASK_ID  >> $HOME/chaos_sim/output/log.chaos_three_species_$SGE_TASK_ID
...
cp /scratch0/karkaria/chaos_three_species_$SGE_TASK_ID/output/*.tar.gz $HOME/chaos_sim/output/
