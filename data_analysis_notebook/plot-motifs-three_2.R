...
species_names <- c(expression(N[1]), expression(N[2]),  expression(N[3]), expression(B[1]), expression(B[2]), expression(B[3]), expression(A[1]), expression(A[2]), expression(A[3]))
...
if(1){
   ...
   dd <- rbind( c(0,0,0,0,0,0,0,0, 0), dd)

   # u, v, w: 0, 1, 2
   elist <- rbind( 
      c(1,1), c(2,1), c(3,1), c(4, 1), c(5, 1), c(6, 1), c(7, 1), c(8, 1), c(9, 1),
      c(1,2), c(2,2), c(3,2), c(4,2), c(5,2), c(6,2), c(7, 2), c(8, 2), c(9, 2),
      c(1,3), c(2,3), c(3,3), c(4,3) , c(5,3), c(6,3), c(7, 3), c(8, 3), c(9, 3),
      c(1,4), c(2,4), c(3,4), c(4,4) , c(5,4), c(6,4),c(7, 4), c(8, 4), c(9, 4),
      c(1,5), c(2,5), c(3,5), c(4,5) , c(5,5), c(6,5),c(7, 5), c(8, 5), c(9, 5),
      c(1,6), c(2,6), c(3,6), c(4,6) , c(5,6), c(6,6),c(7, 6), c(8, 6), c(9, 6),
      c(1,7), c(2,7), c(3,7), c(4,7) , c(5,7), c(6,7), c(7, 7), c(8, 7), c(9, 7),
      c(1,8), c(2,8), c(3,8), c(4,8) , c(5,8), c(6,8), c(7, 8), c(8, 8), c(9, 8),
      c(1,9), c(2,9), c(3,9), c(4,9) , c(5,9), c(6,9), c(7, 9), c(8, 9), c(9, 9)
      )


   layout =  5.3 * rbind( c(0,0), c(0,1), c(1,1), c(1,2), c(2,2), c(2,3)  )

   layout =  1 * rbind( c(-1.25, -1.25), c(1.25, 1.25), c(1.25, -1.25), c(0, -1.25), c(1.25,0), c(-1.25, 0), c(0, 1.25), c(-1.0, 1.0), c(1.0, 1.0)  )
