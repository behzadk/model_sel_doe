...
void Models::model_0(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	const double K_mu_trp = part_params[5];
	const double K_omega_1 = part_params[6];
	const double S0_glu = part_params[7];
	const double S0_trp = part_params[8];
	const double g_1 = part_params[9];
	const double g_2 = part_params[10];
	const double kA_1 = part_params[11];
	const double kA_2 = part_params[12];
	const double kBmax_1 = part_params[13];
	const double kV_1 = part_params[14];
	const double kV_max_1 = part_params[15];
	const double mu_max_1 = part_params[16];
	const double mu_max_2 = part_params[17];
	const double nB_1 = part_params[18];
	const double nV_1 = part_params[19];
	const double n_omega_1 = part_params[20];
	const double omega_max_1 = part_params[21];
	const double p_trp = part_params[22];

	//Species order is: N_1 N_2 S_trp S_glu B_1 A_1 A_2 V_1 
	dydt[0] = -std::pow(y[4], n_omega_1)*K_V_1*y[0]*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[7])) - D*y[0] + y[0]*y[3]*mu_max_1/(K_mu_glu + y[3]);
	dydt[1] = -std::pow(y[4], n_omega_1)*K_V_1*y[1]*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[7])) - D*y[1] + y[1]*y[3]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	dydt[2] = C*y[0]*p_trp - C*y[1]*y[2]*mu_max_2/(g_2*(K_mu_trp + y[2])) + D*(S0_trp - y[2]);
	dydt[3] = -C*y[0]*y[3]*mu_max_1/(g_1*(K_mu_glu + y[3])) - C*y[1]*y[3]*mu_max_2/(g_2*(K_mu_glu + y[3])) + D*(S0_glu - y[3]);
	dydt[4] = std::pow(y[5], nB_1)*C*y[0]*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)) - y[4]*D;
	dydt[5] = -y[5]*D + C*y[0]*kA_1;
	dydt[6] = -y[6]*D + C*y[0]*kA_2;
	dydt[7] = std::pow(y[6], nV_1)*C*y[0]*kV_max_1/(std::pow(y[6], nV_1) + std::pow(kV_1, nV_1)) - D*y[7];
...
void Models::jac_0(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 0 , 0 ) = -std::pow(y[4], n_omega_1)*K_V_1*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[7])) - D + y[3]*mu_max_1/(K_mu_glu + y[3]);
	J( 0 , 1 ) = 0;
	J( 0 , 2 ) = 0;
	J( 0 , 3 ) = -y[0]*y[3]*mu_max_1/std::pow(K_mu_glu + y[3], 2) + y[0]*mu_max_1/(K_mu_glu + y[3]);
	J( 0 , 4 ) = std::pow(y[4], 2*n_omega_1)*K_V_1*y[0]*n_omega_1*omega_max_1/(y[4]*std::pow(std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1), 2)*(K_V_1 + y[7])) - std::pow(y[4], n_omega_1)*K_V_1*y[0]*n_omega_1*omega_max_1/(y[4]*(std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[7]));
	J( 0 , 5 ) = 0;
	J( 0 , 6 ) = 0;
	J( 0 , 7 ) = std::pow(y[4], n_omega_1)*K_V_1*y[0]*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*std::pow(K_V_1 + y[7], 2));
	J( 1 , 0 ) = 0;
	J( 1 , 1 ) = -std::pow(y[4], n_omega_1)*K_V_1*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[7])) - D + y[3]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	J( 1 , 2 ) = -y[1]*y[3]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*std::pow(K_mu_trp + y[2], 2)) + y[1]*y[3]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	J( 1 , 3 ) = -y[1]*y[3]*y[2]*std::pow(mu_max_2, 2)/(std::pow(K_mu_glu + y[3], 2)*(K_mu_trp + y[2])) + y[1]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	J( 1 , 4 ) = std::pow(y[4], 2*n_omega_1)*K_V_1*y[1]*n_omega_1*omega_max_1/(y[4]*std::pow(std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1), 2)*(K_V_1 + y[7])) - std::pow(y[4], n_omega_1)*K_V_1*y[1]*n_omega_1*omega_max_1/(y[4]*(std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[7]));
	J( 1 , 5 ) = 0;
	J( 1 , 6 ) = 0;
	J( 1 , 7 ) = std::pow(y[4], n_omega_1)*K_V_1*y[1]*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*std::pow(K_V_1 + y[7], 2));
	J( 2 , 0 ) = C*p_trp;
	J( 2 , 1 ) = -C*y[2]*mu_max_2/(g_2*(K_mu_trp + y[2]));
	J( 2 , 2 ) = C*y[1]*y[2]*mu_max_2/(g_2*std::pow(K_mu_trp + y[2], 2)) - C*y[1]*mu_max_2/(g_2*(K_mu_trp + y[2])) - D;
	J( 2 , 3 ) = 0;
	J( 2 , 4 ) = 0;
	J( 2 , 5 ) = 0;
	J( 2 , 6 ) = 0;
	J( 2 , 7 ) = 0;
	J( 3 , 0 ) = -C*y[3]*mu_max_1/(g_1*(K_mu_glu + y[3]));
	J( 3 , 1 ) = -C*y[3]*mu_max_2/(g_2*(K_mu_glu + y[3]));
	J( 3 , 2 ) = 0;
	J( 3 , 3 ) = C*y[0]*y[3]*mu_max_1/(g_1*std::pow(K_mu_glu + y[3], 2)) - C*y[0]*mu_max_1/(g_1*(K_mu_glu + y[3])) + C*y[1]*y[3]*mu_max_2/(g_2*std::pow(K_mu_glu + y[3], 2)) - C*y[1]*mu_max_2/(g_2*(K_mu_glu + y[3])) - D;
	J( 3 , 4 ) = 0;
	J( 3 , 5 ) = 0;
	J( 3 , 6 ) = 0;
	J( 3 , 7 ) = 0;
	J( 4 , 0 ) = std::pow(y[5], nB_1)*C*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1));
	J( 4 , 1 ) = 0;
	J( 4 , 2 ) = 0;
	J( 4 , 3 ) = 0;
	J( 4 , 4 ) = -D;
	J( 4 , 5 ) = -std::pow(y[5], 2*nB_1)*C*y[0]*kBmax_1*nB_1/(y[5]*std::pow(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1), 2)) + std::pow(y[5], nB_1)*C*y[0]*kBmax_1*nB_1/(y[5]*(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)));
	J( 4 , 6 ) = 0;
	J( 4 , 7 ) = 0;
	J( 5 , 0 ) = C*kA_1;
	J( 5 , 1 ) = 0;
	...
	J( 6 , 6 ) = -D;
	J( 6 , 7 ) = 0;
	J( 7 , 0 ) = std::pow(y[6], nV_1)*C*kV_max_1/(std::pow(y[6], nV_1) + std::pow(kV_1, nV_1));
	J( 7 , 1 ) = 0;
	J( 7 , 2 ) = 0;
	J( 7 , 3 ) = 0;
	J( 7 , 4 ) = 0;
	J( 7 , 5 ) = 0;
	J( 7 , 6 ) = -std::pow(y[6], 2*nV_1)*C*y[0]*kV_max_1*nV_1/(y[6]*std::pow(std::pow(y[6], nV_1) + std::pow(kV_1, nV_1), 2)) + std::pow(y[6], nV_1)*C*y[0]*kV_max_1*nV_1/(y[6]*(std::pow(y[6], nV_1) + std::pow(kV_1, nV_1)));
	J( 7 , 7 ) = -D;
...
void Models::model_1(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	//Species order is: N_1 N_2 S_trp S_glu B_1 A_1 A_2 V_1 
	dydt[0] = -std::pow(y[4], n_omega_1)*K_V_1*y[0]*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[7])) - D*y[0] + y[0]*y[3]*mu_max_1/(K_mu_glu + y[3]);
	dydt[1] = -D*y[1] + y[1]*y[3]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	dydt[2] = C*y[0]*p_trp - C*y[1]*y[2]*mu_max_2/(g_2*(K_mu_trp + y[2])) + D*(S0_trp - y[2]);
	dydt[3] = -C*y[0]*y[3]*mu_max_1/(g_1*(K_mu_glu + y[3])) - C*y[1]*y[3]*mu_max_2/(g_2*(K_mu_glu + y[3])) + D*(S0_glu - y[3]);
	dydt[4] = std::pow(y[5], nB_1)*C*y[0]*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)) - y[4]*D;
	dydt[5] = -y[5]*D + C*y[0]*kA_1;
...
void Models::jac_1(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 0 , 7 ) = std::pow(y[4], n_omega_1)*K_V_1*y[0]*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*std::pow(K_V_1 + y[7], 2));
	J( 1 , 0 ) = 0;
	J( 1 , 1 ) = -D + y[3]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	J( 1 , 2 ) = -y[1]*y[3]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*std::pow(K_mu_trp + y[2], 2)) + y[1]*y[3]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	J( 1 , 3 ) = -y[1]*y[3]*y[2]*std::pow(mu_max_2, 2)/(std::pow(K_mu_glu + y[3], 2)*(K_mu_trp + y[2])) + y[1]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	J( 1 , 4 ) = 0;
	J( 1 , 5 ) = 0;
...
void Models::model_2(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	dydt[5] = -y[5]*D + C*y[0]*kA_1;
	dydt[6] = -y[6]*D + C*y[0]*kA_2;
	dydt[7] = C*y[0]*std::pow(kV_1, nV_1)*kV_max_1/(std::pow(y[6], nV_1) + std::pow(kV_1, nV_1)) - D*y[7];
...
void Models::jac_2(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 6 , 6 ) = -D;
	J( 6 , 7 ) = 0;
	J( 7 , 0 ) = C*std::pow(kV_1, nV_1)*kV_max_1/(std::pow(y[6], nV_1) + std::pow(kV_1, nV_1));
	J( 7 , 1 ) = 0;
	J( 7 , 2 ) = 0;
	J( 7 , 3 ) = 0;
	J( 7 , 4 ) = 0;
	J( 7 , 5 ) = 0;
	J( 7 , 6 ) = -std::pow(y[6], nV_1)*C*y[0]*std::pow(kV_1, nV_1)*kV_max_1*nV_1/(y[6]*std::pow(std::pow(y[6], nV_1) + std::pow(kV_1, nV_1), 2));
	J( 7 , 7 ) = -D;
...
void Models::model_4(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	dydt[0] = -std::pow(y[4], n_omega_1)*K_V_1*y[0]*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[7])) - D*y[0] + y[0]*y[3]*mu_max_1/(K_mu_glu + y[3]);
	dydt[1] = -std::pow(y[4], n_omega_1)*K_V_1*y[1]*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[7])) - D*y[1] + y[1]*y[3]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	dydt[2] = -C*y[1]*y[2]*mu_max_2/(g_2*(K_mu_trp + y[2])) + D*(S0_trp - y[2]);
	dydt[3] = -C*y[0]*y[3]*mu_max_1/(g_1*(K_mu_glu + y[3])) - C*y[1]*y[3]*mu_max_2/(g_2*(K_mu_glu + y[3])) + D*(S0_glu - y[3]);
	dydt[4] = std::pow(y[5], nB_1)*C*y[0]*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)) - y[4]*D;
	dydt[5] = -y[5]*D + C*y[0]*kA_1;
	dydt[6] = -y[6]*D + C*y[0]*kA_2;
...
void Models::model_6(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	//Species order is: N_1 N_2 S_glu B_1 A_1 A_2 V_1 
	dydt[0] = -std::pow(y[3], n_omega_1)*K_V_1*y[0]*omega_max_1/((std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[6])) - D*y[0] + y[0]*y[2]*mu_max_1/(K_mu_glu + y[2]);
...
void Models::jac_6(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 0 , 0 ) = -std::pow(y[3], n_omega_1)*K_V_1*omega_max_1/((std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[6])) - D + y[2]*mu_max_1/(K_mu_glu + y[2]);
	J( 0 , 1 ) = 0;
	J( 0 , 2 ) = -y[0]*y[2]*mu_max_1/std::pow(K_mu_glu + y[2], 2) + y[0]*mu_max_1/(K_mu_glu + y[2]);
	J( 0 , 3 ) = std::pow(y[3], 2*n_omega_1)*K_V_1*y[0]*n_omega_1*omega_max_1/(y[3]*std::pow(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1), 2)*(K_V_1 + y[6])) - std::pow(y[3], n_omega_1)*K_V_1*y[0]*n_omega_1*omega_max_1/(y[3]*(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[6]));
	J( 0 , 4 ) = 0;
	J( 0 , 5 ) = 0;
	J( 0 , 6 ) = std::pow(y[3], n_omega_1)*K_V_1*y[0]*omega_max_1/((std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1))*std::pow(K_V_1 + y[6], 2));
	J( 1 , 0 ) = 0;
...
void Models::model_12(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	//Species order is: N_1 N_2 S_trp S_glu B_1 A_1 A_2 V_1 
	dydt[0] = -D*y[0] + y[0]*y[3]*mu_max_1/(K_mu_glu + y[3]);
	dydt[1] = -std::pow(y[4], n_omega_1)*K_V_1*y[1]*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[7])) - D*y[1] + y[1]*y[3]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	dydt[2] = C*y[0]*p_trp - C*y[1]*y[2]*mu_max_2/(g_2*(K_mu_trp + y[2])) + D*(S0_trp - y[2]);
	dydt[3] = -C*y[0]*y[3]*mu_max_1/(g_1*(K_mu_glu + y[3])) - C*y[1]*y[3]*mu_max_2/(g_2*(K_mu_glu + y[3])) + D*(S0_glu - y[3]);
	dydt[4] = std::pow(y[5], nB_1)*C*y[0]*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)) - y[4]*D;
...
void Models::jac_12(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 0 , 0 ) = -D + y[3]*mu_max_1/(K_mu_glu + y[3]);
	J( 0 , 1 ) = 0;
	J( 0 , 2 ) = 0;
	J( 0 , 3 ) = -y[0]*y[3]*mu_max_1/std::pow(K_mu_glu + y[3], 2) + y[0]*mu_max_1/(K_mu_glu + y[3]);
	J( 0 , 4 ) = 0;
...
void Models::model_18(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	const double kV_1 = part_params[13];
	const double kV_max_1 = part_params[14];
	const double mu_max_1 = part_params[15];
	const double mu_max_2 = part_params[16];
	const double nB_1 = part_params[17];
	const double nV_1 = part_params[18];
	const double n_omega_1 = part_params[19];
	const double omega_max_1 = part_params[20];
	const double p_trp = part_params[21];

	//Species order is: N_1 N_2 S_trp S_glu B_1 A_1 V_1 
	dydt[0] = -std::pow(y[4], n_omega_1)*K_V_1*y[0]*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[6])) - D*y[0] + y[0]*y[3]*mu_max_1/(K_mu_glu + y[3]);
	dydt[1] = -std::pow(y[4], n_omega_1)*K_V_1*y[1]*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[6])) - D*y[1] + y[1]*y[3]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	dydt[2] = C*y[0]*p_trp - C*y[1]*y[2]*mu_max_2/(g_2*(K_mu_trp + y[2])) + D*(S0_trp - y[2]);
	dydt[3] = -C*y[0]*y[3]*mu_max_1/(g_1*(K_mu_glu + y[3])) - C*y[1]*y[3]*mu_max_2/(g_2*(K_mu_glu + y[3])) + D*(S0_glu - y[3]);
	dydt[4] = std::pow(y[5], nB_1)*C*y[0]*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)) - y[4]*D;
	dydt[5] = -y[5]*D + C*y[0]*kA_1;
...
void Models::jac_18(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 0 , 0 ) = -std::pow(y[4], n_omega_1)*K_V_1*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[6])) - D + y[3]*mu_max_1/(K_mu_glu + y[3]);
	J( 0 , 1 ) = 0;
	J( 0 , 2 ) = 0;
	J( 0 , 3 ) = -y[0]*y[3]*mu_max_1/std::pow(K_mu_glu + y[3], 2) + y[0]*mu_max_1/(K_mu_glu + y[3]);
	J( 0 , 4 ) = std::pow(y[4], 2*n_omega_1)*K_V_1*y[0]*n_omega_1*omega_max_1/(y[4]*std::pow(std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1), 2)*(K_V_1 + y[6])) - std::pow(y[4], n_omega_1)*K_V_1*y[0]*n_omega_1*omega_max_1/(y[4]*(std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[6]));
	J( 0 , 5 ) = 0;
	J( 0 , 6 ) = std::pow(y[4], n_omega_1)*K_V_1*y[0]*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*std::pow(K_V_1 + y[6], 2));
	J( 1 , 0 ) = 0;
	J( 1 , 1 ) = -std::pow(y[4], n_omega_1)*K_V_1*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[6])) - D + y[3]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	J( 1 , 2 ) = -y[1]*y[3]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*std::pow(K_mu_trp + y[2], 2)) + y[1]*y[3]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	J( 1 , 3 ) = -y[1]*y[3]*y[2]*std::pow(mu_max_2, 2)/(std::pow(K_mu_glu + y[3], 2)*(K_mu_trp + y[2])) + y[1]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	J( 1 , 4 ) = std::pow(y[4], 2*n_omega_1)*K_V_1*y[1]*n_omega_1*omega_max_1/(y[4]*std::pow(std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1), 2)*(K_V_1 + y[6])) - std::pow(y[4], n_omega_1)*K_V_1*y[1]*n_omega_1*omega_max_1/(y[4]*(std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[6]));
	J( 1 , 5 ) = 0;
	J( 1 , 6 ) = std::pow(y[4], n_omega_1)*K_V_1*y[1]*omega_max_1/((std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1))*std::pow(K_V_1 + y[6], 2));
	J( 2 , 0 ) = C*p_trp;
	J( 2 , 1 ) = -C*y[2]*mu_max_2/(g_2*(K_mu_trp + y[2]));
	J( 2 , 2 ) = C*y[1]*y[2]*mu_max_2/(g_2*std::pow(K_mu_trp + y[2], 2)) - C*y[1]*mu_max_2/(g_2*(K_mu_trp + y[2])) - D;
	J( 2 , 3 ) = 0;
...
void Models::model_22(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	const double K_mu_trp = part_params[4];
	const double K_omega_1 = part_params[5];
	const double S0_glu = part_params[6];
	const double S0_trp = part_params[7];
	const double g_1 = part_params[8];
	const double g_2 = part_params[9];
	...
	const double p_trp = part_params[17];

	//Species order is: N_1 N_2 S_trp S_glu B_1 A_1 
	dydt[0] = -std::pow(y[4], n_omega_1)*y[0]*omega_max_1/(std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - D*y[0] + y[0]*y[3]*mu_max_1/(K_mu_glu + y[3]);
	dydt[1] = -std::pow(y[4], n_omega_1)*y[1]*omega_max_1/(std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - D*y[1] + y[1]*y[3]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	dydt[2] = C*y[0]*p_trp - C*y[1]*y[2]*mu_max_2/(g_2*(K_mu_trp + y[2])) + D*(S0_trp - y[2]);
	dydt[3] = -C*y[0]*y[3]*mu_max_1/(g_1*(K_mu_glu + y[3])) - C*y[1]*y[3]*mu_max_2/(g_2*(K_mu_glu + y[3])) + D*(S0_glu - y[3]);
	dydt[4] = std::pow(y[5], nB_1)*C*y[0]*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1)) - y[4]*D;
	dydt[5] = -y[5]*D + C*y[0]*kA_1;
...
void Models::jac_22(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 0 , 0 ) = -std::pow(y[4], n_omega_1)*omega_max_1/(std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - D + y[3]*mu_max_1/(K_mu_glu + y[3]);
	J( 0 , 1 ) = 0;
	J( 0 , 2 ) = 0;
	J( 0 , 3 ) = -y[0]*y[3]*mu_max_1/std::pow(K_mu_glu + y[3], 2) + y[0]*mu_max_1/(K_mu_glu + y[3]);
	...
	J( 0 , 5 ) = 0;
	J( 1 , 0 ) = 0;
	J( 1 , 1 ) = -std::pow(y[4], n_omega_1)*omega_max_1/(std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - D + y[3]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	J( 1 , 2 ) = -y[1]*y[3]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*std::pow(K_mu_trp + y[2], 2)) + y[1]*y[3]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	J( 1 , 3 ) = -y[1]*y[3]*y[2]*std::pow(mu_max_2, 2)/(std::pow(K_mu_glu + y[3], 2)*(K_mu_trp + y[2])) + y[1]*y[2]*std::pow(mu_max_2, 2)/((K_mu_glu + y[3])*(K_mu_trp + y[2]));
	J( 1 , 4 ) = std::pow(y[4], 2*n_omega_1)*y[1]*n_omega_1*omega_max_1/(y[4]*std::pow(std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1), 2)) - std::pow(y[4], n_omega_1)*y[1]*n_omega_1*omega_max_1/(y[4]*(std::pow(y[4], n_omega_1) + std::pow(K_omega_1, n_omega_1)));
	J( 1 , 5 ) = 0;
	J( 2 , 0 ) = C*p_trp;
	J( 2 , 1 ) = -C*y[2]*mu_max_2/(g_2*(K_mu_trp + y[2]));
	J( 2 , 2 ) = C*y[1]*y[2]*mu_max_2/(g_2*std::pow(K_mu_trp + y[2], 2)) - C*y[1]*mu_max_2/(g_2*(K_mu_trp + y[2])) - D;
...
void Models::model_26(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	const double n_omega_1 = part_params[17];
	const double omega_max_1 = part_params[18];

	//Species order is: N_1 N_2 S_glu B_1 A_1 V_1 
	dydt[0] = -std::pow(y[3], n_omega_1)*K_V_1*y[0]*omega_max_1/((std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[5])) - D*y[0] + y[0]*y[2]*mu_max_1/(K_mu_glu + y[2]);
	dydt[1] = -std::pow(y[3], n_omega_1)*K_V_1*y[1]*omega_max_1/((std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[5])) - D*y[1] + y[1]*y[2]*mu_max_2/(K_mu_glu + y[2]);
	dydt[2] = -C*y[0]*y[2]*mu_max_1/(g_1*(K_mu_glu + y[2])) - C*y[1]*y[2]*mu_max_2/(g_2*(K_mu_glu + y[2])) + D*(S0_glu - y[2]);
	dydt[3] = std::pow(y[4], nB_1)*C*y[0]*kBmax_1/(std::pow(y[4], nB_1) + std::pow(KB_1, nB_1)) - y[3]*D;
	dydt[4] = -y[4]*D + C*y[0]*kA_1;
...
void Models::jac_26(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 0 , 0 ) = -std::pow(y[3], n_omega_1)*K_V_1*omega_max_1/((std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[5])) - D + y[2]*mu_max_1/(K_mu_glu + y[2]);
	J( 0 , 1 ) = 0;
	J( 0 , 2 ) = -y[0]*y[2]*mu_max_1/std::pow(K_mu_glu + y[2], 2) + y[0]*mu_max_1/(K_mu_glu + y[2]);
	J( 0 , 3 ) = std::pow(y[3], 2*n_omega_1)*K_V_1*y[0]*n_omega_1*omega_max_1/(y[3]*std::pow(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1), 2)*(K_V_1 + y[5])) - std::pow(y[3], n_omega_1)*K_V_1*y[0]*n_omega_1*omega_max_1/(y[3]*(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[5]));
	J( 0 , 4 ) = 0;
	J( 0 , 5 ) = std::pow(y[3], n_omega_1)*K_V_1*y[0]*omega_max_1/((std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1))*std::pow(K_V_1 + y[5], 2));
	J( 1 , 0 ) = 0;
	J( 1 , 1 ) = -std::pow(y[3], n_omega_1)*K_V_1*omega_max_1/((std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[5])) - D + y[2]*mu_max_2/(K_mu_glu + y[2]);
	J( 1 , 2 ) = -y[1]*y[2]*mu_max_2/std::pow(K_mu_glu + y[2], 2) + y[1]*mu_max_2/(K_mu_glu + y[2]);
	J( 1 , 3 ) = std::pow(y[3], 2*n_omega_1)*K_V_1*y[1]*n_omega_1*omega_max_1/(y[3]*std::pow(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1), 2)*(K_V_1 + y[5])) - std::pow(y[3], n_omega_1)*K_V_1*y[1]*n_omega_1*omega_max_1/(y[3]*(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1))*(K_V_1 + y[5]));
	J( 1 , 4 ) = 0;
	J( 1 , 5 ) = std::pow(y[3], n_omega_1)*K_V_1*y[1]*omega_max_1/((std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1))*std::pow(K_V_1 + y[5], 2));
	J( 2 , 0 ) = -C*y[2]*mu_max_1/(g_1*(K_mu_glu + y[2]));
	J( 2 , 1 ) = -C*y[2]*mu_max_2/(g_2*(K_mu_glu + y[2]));
	J( 2 , 2 ) = C*y[0]*y[2]*mu_max_1/(g_1*std::pow(K_mu_glu + y[2], 2)) - C*y[0]*mu_max_1/(g_1*(K_mu_glu + y[2])) + C*y[1]*y[2]*mu_max_2/(g_2*std::pow(K_mu_glu + y[2], 2)) - C*y[1]*mu_max_2/(g_2*(K_mu_glu + y[2])) - D;
	J( 2 , 3 ) = 0;
...
void Models::model_34(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	dydt[0] = -std::pow(y[3], n_omega_1)*y[0]*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - D*y[0] + y[0]*y[2]*mu_max_1/(K_mu_glu + y[2]);
	dydt[1] = -std::pow(y[3], n_omega_1)*y[1]*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - D*y[1] + y[1]*y[2]*mu_max_2/(K_mu_glu + y[2]);
	dydt[2] = -C*y[0]*y[2]*mu_max_1/(g_1*(K_mu_glu + y[2])) - C*y[1]*y[2]*mu_max_2/(g_2*(K_mu_glu + y[2])) + D*(S0_glu - y[2]);
	dydt[3] = std::pow(y[4], nB_1)*C*y[0]*kBmax_1/(std::pow(y[4], nB_1) + std::pow(KB_1, nB_1)) - y[3]*D;
	dydt[4] = -y[4]*D + C*y[0]*kA_1;
...
void Models::jac_34(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 0 , 0 ) = -std::pow(y[3], n_omega_1)*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - D + y[2]*mu_max_1/(K_mu_glu + y[2]);
	J( 0 , 1 ) = 0;
	J( 0 , 2 ) = -y[0]*y[2]*mu_max_1/std::pow(K_mu_glu + y[2], 2) + y[0]*mu_max_1/(K_mu_glu + y[2]);
	J( 0 , 3 ) = std::pow(y[3], 2*n_omega_1)*y[0]*n_omega_1*omega_max_1/(y[3]*std::pow(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1), 2)) - std::pow(y[3], n_omega_1)*y[0]*n_omega_1*omega_max_1/(y[3]*(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)));
	J( 0 , 4 ) = 0;
	J( 1 , 0 ) = 0;
	J( 1 , 1 ) = -std::pow(y[3], n_omega_1)*omega_max_1/(std::pow(y[3], n_omega_1) + std::pow(K_omega_1, n_omega_1)) - D + y[2]*mu_max_2/(K_mu_glu + y[2]);
	J( 1 , 2 ) = -y[1]*y[2]*mu_max_2/std::pow(K_mu_glu + y[2], 2) + y[1]*mu_max_2/(K_mu_glu + y[2]);
...
void Models::model_45(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	dydt[2] = C*y[0]*p_trp - C*y[1]*y[2]*mu_max_2/(g_2*(K_mu_trp + y[2])) + D*(S0_trp - y[2]);
	dydt[3] = -C*y[0]*y[3]*mu_max_1/(g_1*(K_mu_glu + y[3])) - C*y[1]*y[3]*mu_max_2/(g_2*(K_mu_glu + y[3])) + D*(S0_glu - y[3]);
	dydt[4] = std::pow(y[6], nB_1)*C*y[0]*kBmax_1/(std::pow(y[6], nB_1) + std::pow(KB_1, nB_1)) - y[4]*D;
	dydt[5] = -y[5]*D + C*y[0]*kA_1;
	dydt[6] = -y[6]*D + C*y[0]*kA_2;
	dydt[7] = std::pow(y[5], nV_1)*C*y[0]*kV_max_1/(std::pow(y[5], nV_1) + std::pow(kV_1, nV_1)) - D*y[7];
...
void Models::jac_45(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 3 , 6 ) = 0;
	J( 3 , 7 ) = 0;
	J( 4 , 0 ) = std::pow(y[6], nB_1)*C*kBmax_1/(std::pow(y[6], nB_1) + std::pow(KB_1, nB_1));
	J( 4 , 1 ) = 0;
	J( 4 , 2 ) = 0;
	J( 4 , 3 ) = 0;
	J( 4 , 4 ) = -D;
	J( 4 , 5 ) = 0;
	J( 4 , 6 ) = -std::pow(y[6], 2*nB_1)*C*y[0]*kBmax_1*nB_1/(y[6]*std::pow(std::pow(y[6], nB_1) + std::pow(KB_1, nB_1), 2)) + std::pow(y[6], nB_1)*C*y[0]*kBmax_1*nB_1/(y[6]*(std::pow(y[6], nB_1) + std::pow(KB_1, nB_1)));
	J( 4 , 7 ) = 0;
	J( 5 , 0 ) = C*kA_1;
	J( 5 , 1 ) = 0;
	J( 5 , 2 ) = 0;
	...
	J( 6 , 6 ) = -D;
	J( 6 , 7 ) = 0;
	J( 7 , 0 ) = std::pow(y[5], nV_1)*C*kV_max_1/(std::pow(y[5], nV_1) + std::pow(kV_1, nV_1));
	J( 7 , 1 ) = 0;
	J( 7 , 2 ) = 0;
	J( 7 , 3 ) = 0;
	J( 7 , 4 ) = 0;
	J( 7 , 5 ) = -std::pow(y[5], 2*nV_1)*C*y[0]*kV_max_1*nV_1/(y[5]*std::pow(std::pow(y[5], nV_1) + std::pow(kV_1, nV_1), 2)) + std::pow(y[5], nV_1)*C*y[0]*kV_max_1*nV_1/(y[5]*(std::pow(y[5], nV_1) + std::pow(kV_1, nV_1)));
	J( 7 , 6 ) = 0;
	J( 7 , 7 ) = -D;
...
void Models::model_47(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	dydt[5] = -y[5]*D + C*y[0]*kA_1;
	dydt[6] = -y[6]*D + C*y[0]*kA_2;
	dydt[7] = C*y[0]*std::pow(kV_1, nV_1)*kV_max_1/(std::pow(y[5], nV_1) + std::pow(kV_1, nV_1)) - D*y[7];
...
void Models::jac_47(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 6 , 6 ) = -D;
	J( 6 , 7 ) = 0;
	J( 7 , 0 ) = C*std::pow(kV_1, nV_1)*kV_max_1/(std::pow(y[5], nV_1) + std::pow(kV_1, nV_1));
	J( 7 , 1 ) = 0;
	J( 7 , 2 ) = 0;
	J( 7 , 3 ) = 0;
	J( 7 , 4 ) = 0;
	J( 7 , 5 ) = -std::pow(y[5], nV_1)*C*y[0]*std::pow(kV_1, nV_1)*kV_max_1*nV_1/(y[5]*std::pow(std::pow(y[5], nV_1) + std::pow(kV_1, nV_1), 2));
	J( 7 , 6 ) = 0;
	J( 7 , 7 ) = -D;
...
void Models::model_63(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	dydt[2] = C*y[0]*p_trp - C*y[1]*y[2]*mu_max_2/(g_2*(K_mu_trp + y[2])) + D*(S0_trp - y[2]);
	dydt[3] = -C*y[0]*y[3]*mu_max_1/(g_1*(K_mu_glu + y[3])) - C*y[1]*y[3]*mu_max_2/(g_2*(K_mu_glu + y[3])) + D*(S0_glu - y[3]);
	dydt[4] = -y[4]*D + C*std::pow(KB_1, nB_1)*y[0]*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1));
	dydt[5] = -y[5]*D + C*y[0]*kA_1;
	dydt[6] = -y[6]*D + C*y[0]*kA_2;
	dydt[7] = std::pow(y[6], nV_1)*C*y[0]*kV_max_1/(std::pow(y[6], nV_1) + std::pow(kV_1, nV_1)) - D*y[7];
...
void Models::jac_63(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 3 , 6 ) = 0;
	J( 3 , 7 ) = 0;
	J( 4 , 0 ) = C*std::pow(KB_1, nB_1)*kBmax_1/(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1));
	J( 4 , 1 ) = 0;
	J( 4 , 2 ) = 0;
	J( 4 , 3 ) = 0;
	J( 4 , 4 ) = -D;
	J( 4 , 5 ) = -std::pow(y[5], nB_1)*C*std::pow(KB_1, nB_1)*y[0]*kBmax_1*nB_1/(y[5]*std::pow(std::pow(y[5], nB_1) + std::pow(KB_1, nB_1), 2));
	J( 4 , 6 ) = 0;
	J( 4 , 7 ) = 0;
	J( 5 , 0 ) = C*kA_1;
	J( 5 , 1 ) = 0;
...
void Models::model_108(const ublas_vec_t  &y , ublas_vec_t &dydt , double t, std::vector <double> &part_params)
{
	...
	dydt[2] = C*y[0]*p_trp - C*y[1]*y[2]*mu_max_2/(g_2*(K_mu_trp + y[2])) + D*(S0_trp - y[2]);
	dydt[3] = -C*y[0]*y[3]*mu_max_1/(g_1*(K_mu_glu + y[3])) - C*y[1]*y[3]*mu_max_2/(g_2*(K_mu_glu + y[3])) + D*(S0_glu - y[3]);
	dydt[4] = -y[4]*D + C*std::pow(KB_1, nB_1)*y[0]*kBmax_1/(std::pow(y[6], nB_1) + std::pow(KB_1, nB_1));
	dydt[5] = -y[5]*D + C*y[0]*kA_1;
	dydt[6] = -y[6]*D + C*y[0]*kA_2;
	dydt[7] = std::pow(y[5], nV_1)*C*y[0]*kV_max_1/(std::pow(y[5], nV_1) + std::pow(kV_1, nV_1)) - D*y[7];
...
void Models::jac_108(const ublas_vec_t & y , ublas_mat_t &J , const double &/* t*/ , ublas_vec_t &dfdt, std::vector <double> &part_params)
{
	...
	J( 3 , 6 ) = 0;
	J( 3 , 7 ) = 0;
	J( 4 , 0 ) = C*std::pow(KB_1, nB_1)*kBmax_1/(std::pow(y[6], nB_1) + std::pow(KB_1, nB_1));
	J( 4 , 1 ) = 0;
	J( 4 , 2 ) = 0;
	J( 4 , 3 ) = 0;
	J( 4 , 4 ) = -D;
	J( 4 , 5 ) = 0;
	J( 4 , 6 ) = -std::pow(y[6], nB_1)*C*std::pow(KB_1, nB_1)*y[0]*kBmax_1*nB_1/(y[6]*std::pow(std::pow(y[6], nB_1) + std::pow(KB_1, nB_1), 2));
	J( 4 , 7 ) = 0;
	J( 5 , 0 ) = C*kA_1;
	J( 5 , 1 ) = 0;
	J( 5 , 2 ) = 0;
