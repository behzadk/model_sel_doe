...
output_path <- paste(output_dir, "ordered_topos.pdf")
ordred_model_txt_path <- paste(data_dir, "model_order.txt")


# adjacency_mat_dir <- "/home/behzad/Documents/barnes_lab/cplusplus_software/speed_test/repressilator/cpp/input_files_three_species_0/adj_matricies/"
...
if(1){
   ...
   # pdf("plot-core-topologies.pdf",height=8,width=22)
